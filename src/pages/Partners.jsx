...
const PARTNER_ROWS = [
  ...
  },
  {
    id: "PTR-004",
    name: "Airtel Nigeria",
    contact: "Chukwuemeka O.",
    email: "chukwu@airtel.ng",
    country: "NG",
    services: 14,
    users: 7,
    revenue: "₦ 2,100,000",
  ...
  },
  {
    ...
    email: "grace@safaricom.co.ke",
    country: "KE",
    services: 21,
    users: 15,
    revenue: "KES 3,400,000",
    status: "active",
    joined: "2022-11-30",
    lastActive: "Today",
  },
  ...
  },
  {
    ...
    contact: "Tatenda Moyo",
    email: "tatenda@telecel.co.zw",
    country: "ZW",
    services: 7,
    users: 4,
    revenue: "USD 45,000",
  ...
  {
    id: "PTR-010",
    name: "Sudan Telecom (Sudatel)",
    contact: "Omar Al-Rashid",
    email: "omar@sudatel.sd",
    country: "SD",
    services: 5,
    users: 3,
    revenue: "SDG 340,000",
  ...
  },
  {
    id: "PTR-011",
    name: "Zamtel Zambia",
    contact: "Mwila Mwansa",
    email: "mwila@zamtel.zm",
    country: "ZM",
    services: 3,
    users: 2,
    revenue: "ZMW 98,000",
    ...
    >
      <div className="partner-box">
        ...
        <div className="partner-modal-header">
          ...
          <button onClick={onClose} className="partner-modal-close">
            ×
          </button>
        </div>
          ...
          <div className="g-stats3 mb-section">
            {[
              ...
              <div key={s.label} className="partner-stat-cell">
                <div className="stat-num" style={{ "--c": s.color }}>
                  {s.value}
                </div>
...
export default function PagePartners() {
  ...
  const stats = {
    ...
    inactive: PARTNER_ROWS.filter((p) => p.status === "inactive").length,
  };
          ...
          <div className="f-col-10">
            {[
              ...
              },
              {
                ...
                color: AMBER,
                bg: "#fef3c7",
                pct: Math.round((stats.warning / stats.total) * 100),
              },
              {
                label: "InActive",
              ...
              >
                ...
                <span className="stat-num-val" style={{ "--c": s.color }}>
                  {s.count}
                </span>
          ...
          <div className="f-wrap-10">
            ...
            <div className="dt-entries-bar">
              ...
              <select
                ...
                value={perPagePtn}
                onChange={(e) => setPerPagePtn(Number(e.target.value))}
              >
                {[10, 25, 50, 100].map((n) => (
            ...
            <div className="f-gap-6">
              {["All", "Active", "Warning", "InActive"].map((f) => (
                <button
                  key={f}
                  onClick={() => setFilter(f)}
                  className={`partner-filter-pill ${filter === f ? "active" : "inactive"}`}
                >
                  {f}
                </button>
              ))}
