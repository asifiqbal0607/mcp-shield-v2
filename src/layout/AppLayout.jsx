 ...
 */
export default function AppLayout({ role, page, setPage, onLogout, children }) {
  ...
  return (
    <div className="app-root-shell">
      ...
      <TopNav role={role} page={page} setPage={setPage} onLogout={onLogout} />
      ...
      <div className="app-body">
        ...
        {/* Backdrop */}
        {sidebarOpen && (
          <div onClick={() => setSidebarOpen(false)} className="app-sidebar-bd" />
        )}
        ...
        <main className="page-main">
          ...
          <div className="app-breadcrumb-row">
            ...
            <button
              ...
              style={{
                '--fb-bdr': sidebarOpen ? '1px solid #bfdbfe' : '1px solid var(--border)',
