              ...
              {Object.keys(DEVICE_CHECKS).map((tab) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      devTab === tab ? "0 1px 4px rgba(0,0,0,.1)" : "none",
                    transition: "all .15s",
                  }}
                >
                  {tab}
              ...
              {EVENTS.map((evt, i) => {
                ...
                return (
                  <div
                    key={i}
                    style={{
                      border: `1px solid ${isOpen ? "#bbf7d0" : "#f1f5f9"}`,
                      borderRadius: 12,
                      overflow: "hidden",
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div
                            style={{ fontSize: 10, color: SLATE, marginTop: 1 }}
                          >
                            Event Information
                          </div>
                        </div>
